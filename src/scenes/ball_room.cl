...
double sdf_scene(double3 p, int subscene_id) {
    ...
    d = min(d, sdf_sphere(p-(double3)(1.0,1.0,1.0), 0.5));
    d = min(d, sdf_sphere(p-(double3)(1.5,1.9,1.2), 0.5));
    d = min(d, sdf_sphere(p-(double3)(-1.0,1.2,0.5), 0.5));
    d = min(d, sdf_sphere(p-(double3)(0.0,2.1,1.4), 0.5));
    d = min(d, sdf_sphere(p-(double3)(0.4,0.1,2.4), 0.5));
    d = min(d, sdf_sphere(p-(double3)(2.0,0.1,0.4), 0.5));
    d = min(d, sdf_sphere(p-(double3)(-2.2,-0.1,-0.6), 0.5));
    d = min(d, sdf_sphere(p-(double3)(-1.2,1.1,-0.1), 0.5));
